...
{ 
    ...
    { 
        ...
        [HttpDelete]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/store/order/{orderId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/store/inventory")]
        ...
        [HttpPost]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/store/order")]
        [ValidateModelState]
