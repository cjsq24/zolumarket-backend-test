...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/cjsq24/zolumarket_api/1.0.0-oas3/pet/findByTags")]
        [ValidateModelState]
